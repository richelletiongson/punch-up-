...
function BottleModel() {
  ...
  return (
    <group rotation={[0, 0, 0]} position={[0.8, -1.4, 0]} scale={0.18}>
...
function BottleScene({ scrollProgress }) {
  ...
  useFrame(({ camera }) => {
    ...
    // Eye-level, straight-on front view: camera and target share the same Y.
    camera.position.set(0.8, 0.8, z)
...
function App() {
  ...
  return (
    <>
      <div className="stage">
        <Canvas
          camera={{ position: [0.8, 0.8, 1.1], fov: 35, near: 0.01, far: 100 }}
