...
function BottleModel() {
  ...
  return (
    {/* Bottle centered vertically in frame, large but not overflowing when zoomed out */}
    <group rotation={[0, 0, 0]} position={[0.8, -1.4, 0]} scale={0.16}>
...
function BottleScene({ scrollProgress }) {
  ...
  useFrame(({ camera }) => {
    ...
    // Eye-level front view: slightly above bottle center, looking slightly down.
    camera.position.set(0.8, 0.6, z)
