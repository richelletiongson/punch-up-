  ...
  return (
    ...
    >
      ...
      <aside id="staggered-menu-panel" ref={panelRef} className="staggered-menu-panel" aria-hidden={!open}>
        {open && (
          <button className="sm-panel-close" type="button" aria-label="Close menu" onClick={closeMenu}>
            <span className="sm-panel-closeIcon" aria-hidden="true">
              ×
            </span>
          </button>
        )}
